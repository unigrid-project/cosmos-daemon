...
require (
	...
	github.com/unigrid-project/cosmos-gridnode v0.0.12
	github.com/unigrid-project/cosmos-ugdmint v0.0.83
	github.com/unigrid-project/cosmos-unigrid-hedgehog-vesting v0.0.58
